...
@__const.jitentry.numbers = private unnamed_addr constant [5 x i32] [i32 5, i32 6, i32 7, i32 8, i32 10], align 4
...
define i32 @jitentry() #0 {
  ...
  %2 = alloca i32, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %1, ptr align 4 @__const.jitentry.numbers, i64 20, i1 false)
...
6:                                                ; preds = %3
  ...
  %16 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10, i32 noundef %15)
  br label %17
